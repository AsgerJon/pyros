...
"""autogenerated by genpy from msgs/Float32Stamped.msg. Do not edit."""
#  MIT Licence
...
called 'secs')
# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is 
called 'nsecs')
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.seq, _x.header.stamp.secs,
       _x.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
